...
namespace NotiBlock.Backend.Interfaces
{
    public interface IProductService
    {
        ...
        Task<BulkOperationResultDTO<Product>> CreateProductsBulkAsync(List<ProductCreateDTO> items, Guid manufacturerId);
        Task<Product> RegisterProductAsync(ProductRegisterDTO dto, Guid registererId, string role);
        Task<BulkOperationResultDTO<Product>> RegisterProductsBulkAsync(List<ProductRegisterDTO> items, Guid registererId, string role);
